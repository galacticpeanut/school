...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(data) {
        var _this = this;
        this.data = data;
        this.model = new _models_Friend__WEBPACK_IMPORTED_MODULE_2__["Friend"]();
        this.myFriends = [];
        // read all my friends
        this.data.getAllFriends().subscribe(function (res) {
            _this.myFriends = []; // clear prev data
            // Filter to show only friends to belong to me
            for (var i = 0; i < res.length; i++) {
                if (res[i].belongsTo == 'Robert') {
                    _this.myFriends.push(res[i]);
                }
            }
        });
    }
    Tab3Page.prototype.saveFriend = function () {
